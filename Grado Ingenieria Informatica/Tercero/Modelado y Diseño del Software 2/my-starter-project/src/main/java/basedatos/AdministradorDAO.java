...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Administrador) session.load(basedatos.Administrador.class, new Integer(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Administrador) session.get(basedatos.Administrador.class, new Integer(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(basedatos.Administrador.class, new Integer(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(basedatos.Administrador.class, new Integer(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From basedatos.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new basedatos.Administrador();
	}
	
	public static boolean save(basedatos.Administrador administrador) throws PersistentException {
		try {
			MDS2v4GalvezRosenovPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basedatos.Administrador administrador) throws PersistentException {
		try {
			MDS2v4GalvezRosenovPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basedatos.Administrador administrador)throws PersistentException {
		try {
			basedatos.Mensaje[] lMensaje_recibidos = administrador.mensaje_recibido.toArray();
			for(int i = 0; i < lMensaje_recibidos.length; i++) {
				lMensaje_recibidos[i].setDestinatario(null);
			}
			basedatos.Mensaje[] lMensaje_enviados = administrador.mensaje_enviado.toArray();
	...
	public static boolean deleteAndDissociate(basedatos.Administrador administrador, org.orm.PersistentSession session)throws PersistentException {
		try {
			basedatos.Mensaje[] lMensaje_recibidos = administrador.mensaje_recibido.toArray();
			for(int i = 0; i < lMensaje_recibidos.length; i++) {
				lMensaje_recibidos[i].setDestinatario(null);
	...
	public static boolean refresh(basedatos.Administrador administrador) throws PersistentException {
		try {
			MDS2v4GalvezRosenovPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basedatos.Administrador administrador) throws PersistentException {
		try {
			MDS2v4GalvezRosenovPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
