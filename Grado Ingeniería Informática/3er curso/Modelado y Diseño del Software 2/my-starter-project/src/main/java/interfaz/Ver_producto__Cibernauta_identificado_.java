...
public class Ver_producto__Cibernauta_identificado_ extends Ver_producto__Cibernauta_ {
	...
	Ver_comentarios__Cibernauta_identificado_ comentarios = new Ver_comentarios__Cibernauta_identificado_();	
	public int id;
	basedatos.Producto[] bdProductos;
	Escribir_comentario escribir_coment;
	basedatos.Producto p;
	Comentarios lista_comentarios;
	int posFoto;

	public Ver_producto__Cibernauta_identificado_() {		
		inicializar();
	}
	...
	public void escribir_comentario() {
		escribir_coment = new Escribir_comentario();

		//Acceder a escribir comentario
		comentarios.getBoton_escribir_comentario().addClickListener(new ComponentEventListener(){
			@Override
			public void onComponentEvent(ComponentEvent event) {
 
				contenido_tabs.removeAll();
				contenido_tabs.add(escribir_coment);
			}
		});

		//Publicar comentario
		escribir_coment.getBoton_publicar().addClickListener(new ComponentEventListener(){
			@Override
			public void onComponentEvent(ComponentEvent event) {
				if(escribir_coment.comprobar_campos()) {
					escribir_coment.idUsuario = Cibernauta_identificado.usuario.getIdUsuario();
					escribir_coment.idProducto = id;
					escribir_coment.publicar();
					contenido_tabs.remove(escribir_coment);
					contenido_tabs.add(comentarios);
