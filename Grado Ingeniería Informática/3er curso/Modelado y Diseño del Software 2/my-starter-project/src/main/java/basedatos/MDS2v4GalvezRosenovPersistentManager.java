...
public class MDS2v4GalvezRosenovPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS2v4GalvezRosenov";
	...
	private MDS2v4GalvezRosenovPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basedatos.Producto.class);
		aMetadataSources.addAnnotatedClass(basedatos.Oferta.class);
		aMetadataSources.addAnnotatedClass(basedatos.Categoria.class);
		aMetadataSources.addAnnotatedClass(basedatos.Anuncio.class);
		aMetadataSources.addAnnotatedClass(basedatos.Pedido.class);
		aMetadataSources.addAnnotatedClass(basedatos.Usuario.class);
		aMetadataSources.addAnnotatedClass(basedatos.Cibernauta.class);
		aMetadataSources.addAnnotatedClass(basedatos.Repartidor.class);
		aMetadataSources.addAnnotatedClass(basedatos.Encargado_compras.class);
		aMetadataSources.addAnnotatedClass(basedatos.Item.class);
		aMetadataSources.addAnnotatedClass(basedatos.Administrador.class);
		aMetadataSources.addAnnotatedClass(basedatos.Pedido_Entregado.class);
		aMetadataSources.addAnnotatedClass(basedatos.Foto.class);
		aMetadataSources.addAnnotatedClass(basedatos.Pedido_Pendiente.class);
		aMetadataSources.addAnnotatedClass(basedatos.Comentario.class);
		aMetadataSources.addAnnotatedClass(basedatos.Mensaje.class);
		aMetadataSources.addAnnotatedClass(basedatos.Pedido_Enviado.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS2v4GalvezRosenovPersistentManager();
		}
